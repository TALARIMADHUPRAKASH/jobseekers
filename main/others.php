...
if(isset($_POST['retailstoremanager']))
{
	$sql = "SELECT * FROM `search1` WHERE jobtitle='retail store manager'";
}
elseif(isset($_POST['financialmanager']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='financial manager'";
}
elseif(isset($_POST['foodmanager']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='food manager'";
}
elseif(isset($_POST['medicalmanager']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='medical manager'";
}
