...
if(isset($_POST['FundAccountantSpecialist']))
{
	$sql = "SELECT * FROM `search1` WHERE jobtitle='Fund Accountant Specialist'";
}
elseif(isset($_POST['SAPoperator']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='SAP operator'";
}
elseif(isset($_POST['SeniorAccountant']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='Senior Accountant'";
}
elseif(isset($_POST['AccountantAdministrator']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='Accountant Administrator'";
}
