...
{
	$sql = "SELECT * FROM `search1` WHERE jobtitle='clerk' AND companyname NOT IN ('indian bank','Bank of India','punjab national bank','syndicate bank','andhra pragathi graminabank','Andhra Bank','SBI')";
}
elseif(isset($_POST['bankmanager']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='bankmanager' AND companyname NOT IN ('indian bank','Bank of India','punjab national bank','syndicate bank','andhra pragathi graminabank','Andhra Bank','SBI')";
}
elseif(isset($_POST['bankpo']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='bankpo' AND companyname NOT IN ('indian bank','Bank of India','punjab national bank','syndicate bank','andhra pragathi graminabank','Andhra Bank','SBI')";
}
elseif(isset($_POST['cashier']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='cashier' AND companyname NOT IN ('indian bank','Bank of India','punjab national bank','syndicate bank','andhra pragathi graminabank','Andhra Bank','SBI')";
}
