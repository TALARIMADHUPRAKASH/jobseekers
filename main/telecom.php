...
{
	$sql = "SELECT * FROM `search1` WHERE jobtitle='telecaller'";
}
elseif(isset($_POST['HardwareDesignEngineer']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='Hardware Design Engineer'";
}
elseif(isset($_POST['fibermanager']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='fiber manager'";
}
elseif(isset($_POST['RPAconsultant']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='RPA consultant'";
}
