...
{
	$sql = "SELECT * FROM `search1` WHERE jobtitle='professor'";
}
elseif(isset($_POST['assistantprofessor']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='assistant professor'";
}
elseif(isset($_POST['teacher']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='teacher'";
}
elseif(isset($_POST['labassistant']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='lab assistant'";
}
