...
if(isset($_POST['ticketcollector']))
{
	$sql = "SELECT * FROM `search1` WHERE jobtitle='ticketcollector'";
}
elseif(isset($_POST['driver']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='driver'";
}
elseif(isset($_POST['instructor']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='instructor'";
}
elseif(isset($_POST['railwayengineer']))
{
$sql = "SELECT * FROM `search1` WHERE jobtitle='railwayengineer'";
}
